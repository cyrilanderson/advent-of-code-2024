import sys
from functools import cmp_to_key # need this to use a comparator instead of key function for cusom sort
...
# Custom comparator function for sorting a list of nodes from a directed graph
# node_a --> node_b  <===> nodea < nodeb
    ...
    if len(sys.argv) != 2:
        ...
        for sequence in sequences_to_check:
           ...
           if sequence == sorted_seq:
               ...
               total += int(sequence[middle_index])
        print(total)
