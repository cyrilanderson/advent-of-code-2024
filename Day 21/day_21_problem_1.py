...
def main():
    ...
    for code in codes:
        ...
        #print(f"Keypad transitions for first code: {code_keypad_transitions}")
        ...
        #print(f"Dirpad presses for first code: {code_dirpad_presses}")
        # Transforms between the dirpad pressed and the remote dirpad commands needed to move between the buttons on the first dirpad 
